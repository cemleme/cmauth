...
class PermissionsRC extends BaseController {
	...
	{
		return $this->returnLayout('cmauth::permissions.list', ['permissions' => Permission::all()]);
	}
	...
	{
		return $this->returnLayout('cmauth::permissions.create');
	}
	...
	{
		return $this->returnLayout('cmauth::permissions.edit', ['permission' => Permission::find($id)]);
	}
