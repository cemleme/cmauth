...
class UsersController extends BaseController {
	...
	public function getIndex() {
		...
		return $this->returnLayout('cmauth::usergroups', ['users' => $users, 'groups'  => $groups]);
	}
	...
	public function getGroups() {
		...
		return $this->returnLayout('cmauth::grouppermissions', ['permissions' => $permissions, 'groups'  => $groups]);
	}
